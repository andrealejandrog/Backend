...
__all__ = [
    'ISpeechWaveFormatEx', 'DISPID_SPACommit', 'SAFT12kHz16BitStereo',
    'SpeechAudioState', 'SPPHRASERULE', 'SP_VISEME_11',
    'SPRST_INACTIVE_WITH_PURGE', 'SITooSlow', 'SVSFIsNotXML',
    'ISpeechVoice', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SWPUnknownWordPronounceable', 'SWPKnownWordPronounceable',
    'SVSFNLPSpeakPunc', 'SLODynamic', 'SVSFParseSapi',
    'ISpMMSysAudio', 'ISpRecognizer2', 'SP_VISEME_7',
    'SVEEndInputStream', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SpeechObjectTokenCategory', 'SREPropertyStringChange',
    'DISPID_SPIStartTime', 'SBOPause', 'DISPID_SLPsItem',
    'ISpeechPhraseInfoBuilder', 'SAFTDefault', 'SpStream',
    'eWORDTYPE_DELETED', 'ISpeechPhraseRule', 'DISPID_SVResume',
    'DISPID_SpeechVoice', 'DISPID_SDKCreateKey', 'SPFILEMODE',
    'DISPID_SMSGetData', 'Speech_Max_Word_Length',
    'DISPID_SRAudioInput', 'SREHypothesis', 'SAFT48kHz16BitMono',
    'DISPID_SOTCreateInstance', 'DISPID_SMSADeviceId',
    'DISPID_SVEventInterests', 'DISPID_SRCEStartStream',
    'DISPID_SBSSeek', 'SECFEmulateResult', 'DISPID_SPEPronunciation',
    'DISPID_SPEAudioStreamOffset', 'SVP_10', 'SpMMAudioIn',
    'eLEXTYPE_USER', 'DISPID_SRGDictationLoad',
    'IInternetSecurityManager', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SpeechMicTraining', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SOTGetStorageFileName', 'SPSInterjection',
    'SPEI_RECOGNITION', 'SpeechRuleAttributes',
    'DISPID_SLAddPronunciation', 'SpPhraseInfoBuilder',
    'DISPID_SOTId', 'SVF_Stressed', 'DISPID_SGRSTPropertyValue',
    'SPWORDTYPE', 'SpLexicon', 'eLEXTYPE_RESERVED10',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SOTGetDescription', 'SPEI_PHONEME',
    'DISPID_SVSpeakStream', 'DISPIDSPTSI_SelectionOffset',
    'SpeechRegistryUserRoot', 'SRAImport', 'SpNullPhoneConverter',
    'SDKLLocalMachine', 'DISPID_SWFEChannels',
    'DISPID_SVIsUISupported', 'eLEXTYPE_APP',
    'DISPID_SPIReplacements', 'DISPID_SBSRead', 'SRADynamic',
    'SpeechVoiceCategoryTTSRate', 'SPSUnknown', 'SPPS_Verb',
    'SpAudioFormat', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    '_RemotableHandle', 'SPEI_WORD_BOUNDARY',
    'DISPID_SRRTOffsetFromStart', 'SPVOICESTATUS',
    'eLEXTYPE_RESERVED9', 'DISPID_SRAudioInputStream',
    'DISPID_SRCVoicePurgeEvent', 'ISpeechPhraseElements',
    'DISPID_SOTDisplayUI', 'SRERecognition', 'SPSNotOverriden',
    'SpSharedRecognizer', 'DISPID_SPRsCount',
    'DISPID_SpeechFileStream', 'DISPID_SpeechPhraseProperties',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SGRSTRule',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SGRSTText',
    'SpeechGrammarTagUnlimitedDictation', 'SLTUser',
    'IEnumSpObjectTokens', 'SPEI_TTS_AUDIO_LEVEL',
    'SpeechAddRemoveWord', 'DISPID_SRCCreateResultFromMemory',
    'SpeechCategoryRecoProfiles', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SVEBookmark', 'SPBOOKMARKOPTIONS', 'DISPID_SWFEFormatTag',
    'DISPID_SpeechRecoResult', 'STCInprocServer', 'SRATopLevel',
    'DISPID_SPEsCount', 'SPEI_RESERVED6', 'SpInProcRecoContext',
    'DISPID_SPIGetText', 'DISPID_SLAddPronunciationByPhoneIds',
    'SpObjectToken', 'ISpeechAudioStatus', 'DISPID_SpeechPhraseRule',
    'DISPID_SpeechWaveFormatEx', 'SpeechVoiceEvents',
    'DISPID_SRCEventInterests', 'SpeechLexiconType',
    'DISPID_SOTs_NewEnum', 'DISPID_SRGRules', 'SDTPronunciation',
    'SPAS_STOP', 'eLEXTYPE_RESERVED4', 'SPDKL_DefaultLocation',
    'DISPID_SRGCommit', 'DISPID_SVWaitUntilDone',
    'ISpResourceManager', 'SVEAudioLevel',
    'DISPID_SVESentenceBoundary', 'SPINTERFERENCE_TOOFAST',
    'SAFTADPCM_11kHzMono', 'SP_VISEME_13', 'SPPROPERTYINFO',
    'eLEXTYPE_USER_SHORTCUT', 'ISpeechXMLRecoResult',
    'SPPS_RESERVED4', 'SVP_5', 'DISPID_SGRsCommitAndSave', 'SVP_4',
    'DISPID_SpeechBaseStream', 'SpeechVoiceSpeakFlags',
    'SSSPTRelativeToCurrentPosition', 'SPPS_NotOverriden',
    'DISPID_SOTCDefault', 'ISpeechCustomStream', 'ISpRecoContext2',
    'SPDKL_LocalMachine', 'ISpeechPhraseElement',
    'SpeechRegistryLocalMachineRoot', 'SpeechInterference',
    'DISPIDSPTSI', 'SVPAlert', 'SREAllEvents',
    'SpeechRecoProfileProperties', 'SP_VISEME_19', 'SDTDisplayText',
    'SpeechBookmarkOptions', 'SAFT44kHz16BitMono',
    'ISpObjectTokenCategory', 'SPCT_DICTATION', 'STSF_CommonAppData',
    'SAFT32kHz8BitMono', 'SREStreamStart', 'DISPID_SRCVoice',
    'DISPID_SOTCId', 'DISPID_SPRuleFirstElement', 'SPSVerb',
    'SVSFParseMask', 'SpeechTokenKeyUI', 'DISPID_SPRsItem',
    'SPRECOCONTEXTSTATUS', 'SRTAutopause',
    'DISPID_SVAudioOutputStream', 'DISPID_SRCEAudioLevel',
    'DISPID_SPIAudioSizeTime', 'SAFT24kHz8BitStereo',
    'ISpeechPhraseProperty', 'SPLEXICONTYPE', 'DISPID_SGRs_NewEnum',
    'SpeechAudioProperties', 'STSF_FlagCreate', 'SWTDeleted',
    'SGLexical', 'SPEI_START_INPUT_STREAM', 'SVP_3',
    'eLEXTYPE_PRIVATE2', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SRRSetTextFeedback', 'DISPID_SMSALineId',
    'DISPID_SLPType', 'SGRSTTRule', 'SpeechAudioFormatType',
    'SDA_One_Trailing_Space', 'SPRECOSTATE', 'DISPID_SDKEnumKeys',
    'DISPID_SPARecoResult', 'SPRECORESULTTIMES', 'SRTStandard',
    'SPSMF_SAPI_PROPERTIES', 'SRESoundStart', 'SpInprocRecognizer',
    'DISPID_SVEEnginePrivate', 'SpeechVoicePriority', 'ISpPhraseAlt',
    'SPGS_ENABLED', 'SPAUDIOSTATE', 'SPSHT_Unknown',
    'DISPID_SPRuleParent', 'SECNormalConfidence',
    'DISPID_SRGetPropertyNumber', 'DISPID_SpeechAudioStatus',
    'DISPID_SRGetPropertyString', 'IStream', 'SPSHT_EMAIL',
    'SAFT12kHz8BitMono', 'DISPID_SGRsFindRule', 'SPDKL_CurrentUser',
    'ISpeechDataKey', 'SBONone', 'SDKLDefaultLocation',
    'SVSFParseAutodetect', 'DISPID_SRRTStreamTime', 'SPAS_PAUSE',
    'SPSSuppressWord', 'DISPID_SGRSTsCount', 'ISpeechAudio',
    'DISPID_SOTIsUISupported', 'DISPID_SVEWord', 'ISpeechAudioFormat',
    'DISPID_SRIsShared', 'DISPID_SPCPhoneToId',
    'DISPID_SDKSetLongValue', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SLWsItem', 'SPBO_AHEAD', 'SpeechPropertyAdaptationOn',
    'DISPID_SOTRemove', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SpeechAudioFormat', 'SpUnCompressedLexicon',
    'SFTSREngine', 'DISPID_SRGCmdLoadFromResource', 'SP_VISEME_17',
    'SVP_17', 'SSTTTextBuffer', 'SVEVoiceChange',
    'ISpeechLexiconWords', 'DISPID_SRCEBookmark',
    'DISPID_SRCEEnginePrivate', 'DISPID_SpeechPhraseElement',
    'eLEXTYPE_RESERVED6', '_ISpeechVoiceEvents',
    'DISPID_SVSCurrentStreamNumber', 'SAFT11kHz8BitMono', 'SVPOver',
    'SPWF_INPUT', 'SP_VISEME_16', 'DISPID_SPRuleId',
    'DISPID_SVEAudioLevel', 'SAFT12kHz8BitStereo', 'SPEI_UNDEFINED',
    'DISPID_SPANumberOfElementsInResult', 'eLEXTYPE_PRIVATE16',
    'ISpeechObjectTokenCategory', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SDA_No_Trailing_Space', 'DISPID_SPIEnginePrivateData',
    'SPEI_VISEME', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SP_VISEME_14',
    'DISPID_SpeechLexiconWord', 'SpeechPropertyComplexResponseSpeed',
    'SINoSignal', 'SpeechTokenKeyFiles', 'DISPID_SLGetPronunciations',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SRRTimes',
    'DISPID_SPEActualConfidence', 'SpeechDataKeyLocation',
    'DISPID_SVSVisemeId', 'ISpeechRecoResult2',
    'DISPID_SRSCurrentStreamNumber', 'SRAORetainAudio',
    'SPRECOGNIZERSTATUS', 'SGDSInactive', 'DISPID_SRCPause',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPVISEMES',
    'SPRST_ACTIVE_ALWAYS', 'SAFT44kHz8BitMono', 'SINoise',
    'SGDisplay', 'ISpXMLRecoResult', 'SPSHT_NotOverriden', 'SVP_13',
    'DISPID_SLRemovePronunciation',
    'DISPID_SRCERecognizerStateChange', 'SAFT16kHz8BitStereo',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SVGetVoices',
    'DISPID_SGRSTs_NewEnum', 'STCLocalServer', 'DISPID_SGRsAdd',
    'SSFMCreateForWrite', 'DISPID_SPIElements',
    'SPINTERFERENCE_NOISE', 'DISPID_SPIRule', 'SAFT8kHz8BitStereo',
    'ISpeechRecoResult', 'DISPID_SASFreeBufferSpace',
    'ISpeechPhraseAlternates', 'SPDKL_CurrentConfig',
    'SPDATAKEYLOCATION', 'SECFDefault', 'DISPID_SLPPartOfSpeech',
    'DISPID_SRCSetAdaptationData', 'SGSExclusive',
    'ISpeechLexiconPronunciation', 'DISPID_SPIAudioStreamPosition',
    'SDTRule', 'SRERecoOtherContext', 'SPSHORTCUTPAIRLIST',
    'SAFTADPCM_44kHzStereo', 'ISpeechVoiceStatus',
    'SRADefaultToActive', 'SDTAlternates',
    'DISPID_SpeechRecognizerStatus', 'SSFMCreate', 'ISpRecoGrammar',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SLWs_NewEnum', 'SP_VISEME_0',
    'DISPID_SpeechPhraseProperty', 'SPSFunction', 'ISequentialStream',
    'SAFT11kHz8BitStereo', 'SAFT22kHz16BitStereo', 'SVP_1',
    'SAFT8kHz16BitStereo', 'SpeechCategoryAppLexicons',
    'ISpeechPhraseReplacement',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPEI_SR_PRIVATE',
    'ISpeechBaseStream', 'SAFT22kHz8BitMono', 'SP_VISEME_1',
    'DISPID_SPPFirstElement', 'DISPID_SpeechLexiconPronunciation',
    'eWORDTYPE_ADDED', 'SPEI_ADAPTATION', 'DISPID_SRRGetXMLErrorInfo',
    'SPVPRIORITY', 'SAFT11kHz16BitStereo', 'DISPID_SRCEHypothesis',
    'SP_VISEME_8', 'SVEPrivate', 'DISPID_SAVolume', 'DISPID_SAStatus',
    'DISPID_SpeechGrammarRule', 'IInternetSecurityMgrSite',
    'DISPID_SASCurrentSeekPosition', 'SpeechAudioFormatGUIDText',
    'DISPID_SVVolume', 'SVPNormal', 'SPBO_NONE', 'SP_VISEME_18',
    'SpeechRunState', 'SVEPhoneme', 'DISPID_SPILanguageId',
    'LONG_PTR', 'DISPID_SPPValue', 'SPEI_SOUND_START',
    'eLEXTYPE_PRIVATE4', 'SP_VISEME_5', 'DISPID_SOTSetId',
    'DISPID_SABufferInfo', 'SWPUnknownWordUnpronounceable',
    'SPEI_RECO_OTHER_CONTEXT', 'SPCT_COMMAND',
    'DISPID_SRSCurrentStreamPosition', 'SPEI_RESERVED5',
    'SPPS_RESERVED3', 'DISPID_SGRAddState', 'SAFT11kHz16BitMono',
    'SPEI_HYPOTHESIS', 'SPEI_TTS_PRIVATE', 'SAFTGSM610_11kHzMono',
    'SPPS_RESERVED1', 'DISPID_SPCLangId', 'ISpeechRecoContext',
    'SPFM_NUM_MODES', 'DISPID_SPRulesCount', 'DISPID_SBSFormat',
    'eLEXTYPE_PRIVATE15', 'SAFTTrueSpeech_8kHz1BitMono',
    'SREPhraseStart', 'SAFT48kHz8BitMono', 'SPSHORTCUTPAIR',
    'SVF_Emphasis', 'SVSFNLPMask', 'SPPARTOFSPEECH',
    'DISPID_SRRAlternates', 'SpResourceManager',
    'SAFT44kHz8BitStereo', 'DISPID_SGRsCommit', 'SDTLexicalForm',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SASetState', 'SRSInactiveWithPurge', 'DISPID_SRDisplayUI',
    'DISPID_SVPause', 'SpVoice', 'DISPID_SpeechDataKey',
    'ISpeechObjectToken', 'DISPID_SRGetFormat', 'ISpeechPhraseInfo',
    'SPAS_CLOSED', 'DISPID_SPEDisplayAttributes', 'SSFMOpenForRead',
    'DISPID_SpeechPhraseReplacements', 'eLEXTYPE_PRIVATE13',
    'SECFIgnoreWidth', 'ISpeechGrammarRule',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SVAudioOutput',
    'STCRemoteServer', 'ISpRecognizer', 'SASPause', 'DISPID_SRState',
    'SpeechRecoEvents', 'DISPID_SMSAMMHandle',
    'DISPID_SRSetPropertyString', 'DISPID_SGRSTNextState',
    'DISPID_SVEPhoneme', 'SPEI_PROPERTY_NUM_CHANGE', 'SRTEmulated',
    'SpeechCategoryAudioOut', 'DISPID_SRCEPropertyNumberChange',
    'SRAInterpreter', 'DISPID_SDKGetBinaryValue',
    'DISPID_SpeechPhraseReplacement', 'ISpStreamFormatConverter',
    'DISPID_SpeechPhraseAlternate', 'SPEI_RESERVED2',
    'SAFTADPCM_8kHzMono', 'DISPID_SPRDisplayAttributes',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SPPsCount',
    'ISpeechPhraseAlternate', 'DISPID_SRCRetainedAudioFormat',
    'DISPID_SRCRequestedUIType', 'SP_VISEME_20', 'SGRSTTDictation',
    'SSTTWildcard', 'DISPID_SLPs_NewEnum', 'SPAR_Low',
    'DISPID_SpeechLexiconProns', 'SVP_2', 'DISPID_SRGReset',
    'DISPID_SRRPhraseInfo', 'SP_VISEME_21',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SpeechPhraseElements',
    'DISPID_SLWLangId', 'SASClosed', 'DISPID_SVEStreamStart',
    'SPAO_NONE', 'DISPID_SVSLastBookmark',
    'SAFTCCITT_ALaw_8kHzStereo', 'SPPS_Function',
    'ISpeechPhraseProperties', 'SAFTADPCM_22kHzStereo',
    'DISPID_SPEAudioSizeTime', 'SPEI_SR_AUDIO_LEVEL',
    'SAFTCCITT_ALaw_8kHzMono', 'SASRun', 'Speech_Default_Weight',
    'ISpGrammarBuilder', 'SPWORDPRONUNCIATION', 'SPRULESTATE',
    'SGDSActive', 'SWTAdded', 'DISPID_SWFEExtraData',
    'SPEI_REQUEST_UI', 'DISPID_SPPConfidence', 'SVF_None',
    'SAFT22kHz8BitStereo', 'SpStreamFormatConverter',
    'SpTextSelectionInformation', 'DISPID_SDKDeleteValue',
    'DISPID_SRGDictationSetState', 'SITooFast', 'SVP_11',
    'SPSERIALIZEDPHRASE', 'SpeechAllElements', 'SVP_18',
    'eLEXTYPE_PRIVATE6', 'DISPID_SRSSupportedLanguages',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SRCRecognizer',
    'eLEXTYPE_PRIVATE20', 'DISPIDSPTSI_SelectionLength',
    'DISPID_SRSNumberOfActiveRules', 'SRTSMLTimeout',
    'DISPID_SRProfile', 'SPSEMANTICERRORINFO', 'SPLO_STATIC',
    'SPPS_SuppressWord', 'SPGRAMMARSTATE', 'SAFTGSM610_8kHzMono',
    'STCAll', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SOTMatchesAttributes', 'DISPID_SFSOpen',
    'DISPID_SpeechXMLRecoResult', 'SRSActive', 'SpeechStreamFileMode',
    'DISPID_SRCreateRecoContext', 'SpeechTokenValueCLSID', 'SVP_14',
    'ISpeechGrammarRuleStateTransitions', 'SPCT_SUB_DICTATION',
    'SpeechCategoryRecognizers', 'SPPHRASEPROPERTY', 'SpMMAudioEnum',
    'DISPID_SVSpeak', 'eLEXTYPE_MORPHOLOGY', 'SLTApp',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SpeechPhraseBuilder',
    'SPEI_PHRASE_START', 'SpeechRuleState', 'DISPID_SADefaultFormat',
    'SAFT32kHz16BitStereo', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPEI_RESERVED3', 'DISPID_SPRuleConfidence',
    'SPRS_ACTIVE_USER_DELIMITED', 'SPPS_Noncontent',
    'ISpeechObjectTokens', 'SAFT16kHz8BitMono', 'DISPID_SVEViseme',
    'SAFTExtendedAudioFormat', 'SREAudioLevel', 'ISpeechFileStream',
    'DISPID_SPRFirstElement', 'SPFM_CREATE_ALWAYS',
    'SAFTNoAssignedFormat', 'STSF_LocalAppData', 'DISPID_SOTCategory',
    'SPWT_LEXICAL', 'DISPID_SRGState', 'SPCS_DISABLED',
    'SGLexicalNoSpecialChars', 'DISPID_SRGDictationUnload',
    'DISPID_SPISaveToMemory', 'DISPID_SDKEnumValues',
    'DISPID_SpeechObjectToken', 'DISPID_SWFEBitsPerSample',
    'DISPID_SpeechRecoResult2', 'SPAUDIOSTATUS', 'SPXRO_SML',
    'eLEXTYPE_VENDORLEXICON', 'tagSPTEXTSELECTIONINFO', 'SDTProperty',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPPS_RESERVED2',
    'SpeechGrammarTagWildcard', 'DISPID_SPEsItem',
    'DISPID_SABIEventBias', 'DISPID_SVGetAudioInputs',
    'SpeechRecognitionType', 'SPWT_DISPLAY', 'SPAUDIOOPTIONS',
    'DISPID_SRCBookmark', 'SPSNoun', 'SRAExport', 'tagSPPROPERTYINFO',
    'SPRST_ACTIVE', 'DISPID_SABufferNotifySize', 'SPPS_Modifier',
    'ISpEventSink', 'SpeechRecognizerState',
    'DISPID_SpeechPhraseInfo', 'DISPID_SRRSaveToMemory',
    'SP_VISEME_3', 'SpeechCategoryAudioIn',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SGRAddResource',
    'SAFTCCITT_uLaw_11kHzMono', 'SAFTADPCM_8kHzStereo',
    'SpeechSpecialTransitionType', 'SRCS_Enabled',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SPIRetainedSizeBytes', 'STSF_AppData', 'SVEBookmark',
    ...
    'DISPID_SAFSetWaveFormatEx', 'SP_VISEME_9', 'SPEI_RESERVED1',
    'SPINTERFERENCE_NONE', 'DISPID_SGRsCount', 'eLEXTYPE_PRIVATE14',
    'SPSHORTCUTTYPE', 'SAFTCCITT_ALaw_44kHzStereo', 'DISPID_SPPId',
    'DISPID_SRSClsidEngine', 'DISPID_SCSBaseStream',
    'SpeechDiscardType', 'ISpRecoCategory', 'DISPID_SGRClear',
    'SPAR_High', 'SRSInactive', 'SREFalseRecognition', 'tagSTATSTG',
    'DISPID_SLGetGenerationChange', 'SPPS_LMA', 'SPEI_SR_BOOKMARK',
    'SAFTCCITT_ALaw_44kHzMono', 'SpMMAudioOut', 'SGRSTTTextBuffer',
    'SPCS_ENABLED', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SRRTLength',
    'DISPID_SpeechPhraseAlternates', 'ISpeechRecoGrammar',
    'SAFTADPCM_22kHzMono', 'DISPID_SDKDeleteKey',
    'DISPID_SpeechObjectTokens', 'DISPID_SVSRunningState',
    'DISPID_SPPs_NewEnum', 'DISPID_SGRSAddSpecialTransition',
    'SDKLCurrentUser', 'DISPID_SPRulesItem', 'ISpeechPhoneConverter',
    'SVSFPersistXML', 'SPSTREAMFORMATTYPE', 'SVEAllEvents',
    'DISPID_SpeechGrammarRules', 'SPGS_EXCLUSIVE', 'ISpAudio',
    'SpeechTokenKeyAttributes', 'SRSActiveAlways', 'SDTAudio',
    'SPFM_OPEN_READWRITE', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SWFEBlockAlign', 'ISpDataKey', 'DISPID_SVVoice',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SDKOpenKey',
    'DISPID_SVSyncronousSpeakTimeout', 'ISpRecognizer3',
    'ISpPhoneticAlphabetSelection', 'DISPID_SRGId', 'SVSFDefault',
    'eLEXTYPE_PRIVATE3', 'SRARoot', 'DISPID_SVSInputWordPosition',
    'SDTAll', 'ISpProperties', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPCONTEXTSTATE', 'SFTInput',
    'SpeechPropertyNormalConfidenceThreshold', 'SPCT_SLEEP',
    'SPWORDPRONOUNCEABLE', 'UINT_PTR', 'SpeechUserTraining',
    'DISPID_SPIProperties', 'DISPID_SPRuleChildren', 'SVSFParseSsml',
    'ISpeechPhraseRules', '__MIDL_IWinTypes_0009',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SLWPronunciations',
    'SAFT24kHz16BitMono', 'SPADAPTATIONRELEVANCE', 'DISPID_SRCState',
    'SPEI_INTERFERENCE', 'DISPID_SRGIsPronounceable',
    'SPBO_TIME_UNITS', 'DISPID_SAFGuid', 'SVP_8',
    'SSSPTRelativeToEnd', 'SpeechAudioVolume', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPAsItem', 'eLEXTYPE_PRIVATE7',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPWORDLIST', 'SPRS_ACTIVE',
    'SPVPRI_NORMAL', 'DISPID_SPRText', 'SPEVENTENUM',
    'SPCATEGORYTYPE', '_ISpeechRecoContextEvents', 'SPSMF_UPS',
    'DISPID_SDKSetStringValue', 'SINone', 'DISPID_SPRuleName',
    'DISPID_SVDisplayUI', 'DISPID_SFSClose',
    'SAFTCCITT_uLaw_8kHzStereo', 'SAFTGSM610_22kHzMono',
    'DISPID_SPIEngineId', 'SpeechGrammarWordType',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SOTCGetDataKey',
    'SAFT48kHz16BitStereo', 'SGDSActiveWithAutoPause',
    'ISpeechTextSelectionInformation', 'DISPID_SOTDataKey',
    'SRSEIsSpeaking', 'SPXRO_Alternates_SML', 'ISpPhrase',
    'eLEXTYPE_PRIVATE10', 'DISPID_SVSInputWordLength',
    'DISPID_SGRName', 'DISPID_SPPEngineConfidence',
    'DISPID_SLGetWords', 'DISPID_SpeechPhoneConverter', 'ISpStream',
    'DISPID_SVPriority', 'ISpNotifySink', 'SREStreamEnd',
    'DISPID_SRGCmdLoadFromFile', 'SPBO_PAUSE',
    'DISPID_SpeechMMSysAudio', 'DISPID_SPRuleNumberOfElements',
    'eLEXTYPE_PRIVATE8', 'DISPID_SPRs_NewEnum',
    'ISpeechRecoResultDispatch', 'SpeechEmulationCompareFlags',
    'DISPID_SGRsItem', 'ISpeechMemoryStream', 'SVP_21',
    'DISPID_SWFESamplesPerSec', 'DISPID_SRGSetWordSequenceData',
    'SPFM_OPEN_READONLY', 'DISPID_SPPBRestorePhraseFromMemory',
    'SGRSTTWord', 'DISPID_SGRSTType', 'SPAS_RUN', 'SpWaveFormatEx',
    'SpCompressedLexicon', 'eLEXTYPE_PRIVATE11', 'SP_VISEME_6',
    'SVP_19', 'SAFTGSM610_44kHzMono', 'SVSFIsFilename',
    'SpFileStream', 'DISPID_SVGetAudioOutputs',
    'DISPID_SPPNumberOfElements', 'SpeechWordPronounceable',
    'DISPID_SPAsCount', 'DISPID_SRRecognizer',
    'SpeechDisplayAttributes', 'DISPID_SpeechAudio',
    'DISPID_SRRAudio', 'DISPID_SVSPhonemeId', 'DISPID_SRRTTickCount',
    'SP_VISEME_12', 'SPRS_INACTIVE', 'SRERequestUI', 'SPEI_MAX_SR',
    'SpPhoneConverter', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPIDSPRG', 'SVEStartInputStream', 'DISPID_SVRate',
    'DISPID_SPAPhraseInfo', 'DISPID_SRCERecognitionForOtherContext',
    'SECFNoSpecialChars', 'DISPID_SRGCmdLoadFromObject',
    'SPINTERFERENCE', 'DISPID_SVAlertBoundary',
    'DISPID_SVSLastResult', 'DISPID_SVSLastBookmarkId',
    'ISpEventSource', 'ISpStreamFormat', 'SpeechLoadOption',
    'SpeechAudioFormatGUIDWave', 'ISpVoice', 'SPEI_END_SR_STREAM',
    'DISPID_SPAStartElementInResult', 'DISPID_SPPName', 'SRESoundEnd',
    'SAFT32kHz8BitStereo', 'SP_VISEME_4', 'eLEXTYPE_PRIVATE18',
    'IEnumString', 'DISPID_SRCCreateGrammar',
    'DISPID_SpeechRecoContextEvents', 'SpeechRecoContextState',
    'SpPhoneticAlphabetConverter', 'SPWAVEFORMATTYPE',
    'ISpeechGrammarRuleState', 'SPEI_RECO_STATE_CHANGE',
    'SpeechCategoryPhoneConverters', 'SPTEXTSELECTIONINFO',
    'SpeechStreamSeekPositionType', 'SpeechVoiceSkipTypeSentence',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SLPLangId',
    'DISPID_SpeechVoiceEvent', 'SpeechDictationTopicSpelling',
    'SPAO_RETAIN_AUDIO', 'SpeechTokenShellFolder',
    'SPWORDPRONUNCIATIONLIST', 'SPEI_MAX_TTS', 'DISPID_SVGetProfiles',
    'DISPID_SRGSetTextSelection', 'DISPID_SRRAudioFormat',
    'SAFTNonStandardFormat', 'SITooLoud', 'SAFT16kHz16BitMono',
    'SDKLCurrentConfig', 'DISPID_SpeechCustomStream', 'SP_VISEME_2',
    'SPEVENTSOURCEINFO', 'SPLO_DYNAMIC', 'SPFM_CREATE',
    'DISPID_SRCESoundEnd', 'SDTReplacement',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SRCEFalseRecognition',
    'ISpLexicon', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SRGetRecognizers', 'SAFT12kHz16BitMono', 'SVP_6',
    'DISPID_SPRNumberOfElements', 'DISPID_SGRSTPropertyId',
    'STCInprocHandler', 'DISPID_SABIBufferSize', 'SAFT32kHz16BitMono',
    'DISPID_SRRDiscardResultInfo', 'Speech_StreamPos_Asap',
    'DISPID_SAFType', 'SPEI_MIN_SR', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SASStop', 'eLEXTYPE_PRIVATE19', 'DISPID_SPPChildren',
    'DISPID_SVEStreamEnd', 'SpeechVisemeFeature',
    'SpeechGrammarState', 'SP_VISEME_15', 'DISPID_SGRAttributes',
    'SPSModifier', 'SVP_16', 'SVSFUnusedFlags', 'SAFTADPCM_44kHzMono',
    'DISPID_SASNonBlockingIO', 'DISPID_SPIGetDisplayAttributes',
    'SPWT_PRONUNCIATION', 'SpeechFormatType', 'DISPID_SGRsDynamic',
    'ISpNotifySource', 'DISPID_SASState', 'DISPID_SRSAudioStatus',
    'SPPS_Unknown', 'ISpeechRecoResultTimes', 'eLEXTYPE_RESERVED7',
    'DISPID_SpeechLexicon', 'SECFIgnoreCase', 'DISPID_SRCEAdaptation',
    '_SPAUDIOSTATE', 'SGSDisabled', 'ISpeechPhraseReplacements',
    'SPPHRASE', 'DISPID_SRCERecognition',
    'SpeechGrammarRuleStateTransitionType', 'SPPHRASEREPLACEMENT',
    'DISPID_SOTCSetId', 'SPWF_SRENGINE', 'SRTReSent',
    'ISpeechRecognizerStatus', 'DISPID_SPEAudioTimeOffset',
    'SPAR_Unknown', 'DISPID_SRRRecoContext', 'DISPID_SPEDisplayText',
    'SPPS_Interjection', 'WAVEFORMATEX',
    'ISpeechLexiconPronunciations', 'DISPID_SBSWrite',
    'SAFT8kHz16BitMono', 'SPRST_NUM_STATES', 'SPEI_VOICE_CHANGE',
    'Speech_Max_Pron_Length', 'SAFT8kHz8BitMono', 'SRAONone',
    'DISPID_SpeechRecoContext', 'DISPIDSPTSI_ActiveLength',
    'SVSFIsXML', 'SSTTDictation', 'SPAUDIOBUFFERINFO',
    'SpeechCategoryVoices', 'DISPID_SDKGetStringValue',
    'SPVPRI_ALERT', 'SpeechRetainedAudioOptions',
    'SAFTCCITT_uLaw_44kHzMono', 'SPEI_START_SR_STREAM',
    'ISpeechGrammarRules', 'DISPID_SRCESoundStart', 'SREPrivate',
    'DISPID_SOTsItem', 'SPEI_TTS_BOOKMARK', 'DISPID_SLPPhoneIds',
    'DISPID_SPELexicalForm', 'SAFT22kHz16BitMono', 'ISpeechLexicon',
    'DISPID_SWFEAvgBytesPerSec', 'SRSEDone',
    'DISPID_SpeechRecognizer', 'SVP_20', 'SPPS_Noun',
    'DISPID_SAEventHandle', 'DISPID_SPEs_NewEnum',
    'DISPID_SVSInputSentenceLength', 'DISPID_SRCEInterference',
    'DISPID_SAFGetWaveFormatEx', 'eLEXTYPE_PRIVATE12', 'SVP_7',
    'SECHighConfidence', 'ISpeechLexiconWord',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SpSharedRecoContext',
    'SLOStatic', 'SpeechVisemeType', 'SPEVENT', 'SPXMLRESULTOPTIONS',
    'SVSFlagsAsync', 'ISpShortcut', 'SRTExtendableParse',
    'SpeechTokenIdUserLexicon', 'SpeechEngineProperties',
    'Speech_StreamPos_RealTime', 'DISPID_SPAs_NewEnum',
    'SAFTADPCM_11kHzStereo', 'DISPID_SRIsUISupported',
    'DISPID_SRGRecoContext', 'SSSPTRelativeToStart', 'ISpRecoContext',
    'SGRSTTWildcard', 'ISpNotifyTranslator', 'SAFT16kHz16BitStereo',
    'SAFTText', 'DISPID_SPIAudioSizeBytes', 'SRCS_Disabled',
    'DISPID_SGRInitialState', 'DISPID_SOTGetAttribute',
    'eLEXTYPE_RESERVED8', 'DISPID_SVEVoiceChange',
    'ISpeechMMSysAudio', 'ISpObjectToken', 'SVP_9',
    'DISPID_SRSetPropertyNumber', 'DISPID_SGRSTPropertyName',
    'SPCT_SUB_COMMAND', 'SpeechTokenContext', 'SVEWordBoundary',
    'SAFTCCITT_ALaw_11kHzMono', 'ISpeechRecognizer', 'SP_VISEME_10',
    'DISPID_SDKGetlongValue', 'DISPID_SLPsCount',
    'SECFIgnoreKanaType', 'SPRST_INACTIVE', 'SpNotifyTranslator',
    'SVSFVoiceMask', 'SPLOADOPTIONS', 'SREStateChange',
    'DISPID_SRCEPhraseStart', 'SpObjectTokenCategory', 'SPRULE',
    'eLEXTYPE_PRIVATE9', 'DISPID_SPPParent', 'SpeechWordType',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SPEI_SOUND_END',
    'SpeechGrammarTagDictation', 'DISPID_SRCERequestUI',
    'ISpSerializeState', 'SPPHRASEELEMENT',
    'DISPID_SABIMinNotification', 'DISPID_SDKSetBinaryValue',
    'SREInterference', 'DISPID_SPERetainedStreamOffset',
    'SPSEMANTICFORMAT', 'DISPID_SRCResume', 'SGSEnabled',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SREAdaptation',
    'DISPID_SVSInputSentencePosition', 'DISPID_SpeechLexiconWords',
    'SVP_0', 'DISPID_SRRSpeakAudio', 'SpeechEngineConfidence',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SLWWord',
    'SPSERIALIZEDRESULT', 'SAFT44kHz16BitStereo',
    'SVSFPurgeBeforeSpeak', 'SPGS_DISABLED', 'SAFT24kHz16BitStereo',
    'DISPID_SVStatus', 'DISPID_SPERequiredConfidence',
    'DISPID_SRGCmdSetRuleIdState', 'SPGRAMMARWORDTYPE',
    'SPBINARYGRAMMAR', 'ISpObjectWithToken', 'ISpRecoGrammar2',
    'DISPID_SPRules_NewEnum', 'SAFTCCITT_uLaw_22kHzMono',
    'eLEXTYPE_PRIVATE1', 'DISPID_SRCEEndStream',
    'ISpeechAudioBufferInfo', 'DISPID_SRStatus',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SRRGetXMLResult',
    'SpeechPropertyResourceUsage', 'DISPID_SLWsCount',
    'SVESentenceBoundary', 'DISPID_SRCEPropertyStringChange',
    'ISpPhoneticAlphabetConverter', 'DISPID_SGRSRule',
    'DISPID_SGRSTransitions', 'ISpRecoResult', 'SpShortcut',
    'DISPID_SpeechVoiceStatus', 'ISpPhoneConverter',
    'SDA_Two_Trailing_Spaces', 'SGRSTTEpsilon', 'DISPID_SLPSymbolic',
    'DISPID_SLGenerationId', 'SPEI_MIN_TTS', 'SpCustomStream',
    'SPINTERFERENCE_TOOSLOW', 'SVP_12', 'SPSHT_OTHER',
    'DISPID_SVSkip', 'DISPID_SLWType', 'SPAR_Medium',
    'SPEI_END_INPUT_STREAM', 'SREBookmark',
    'DISPID_SPEEngineConfidence', 'DISPID_SOTsCount',
    'SpMemoryStream', 'DISPID_SPCIdToPhone',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SGRSAddWordTransition',
    'SpeechPartOfSpeech', 'SVP_15', 'DISPID_SpeechMemoryStream',
    'DISPID_SMSSetData', 'SPVPRI_OVER', 'SAFTCCITT_uLaw_11kHzStereo',
    'SSFMOpenReadWrite', 'SAFT24kHz8BitMono', 'SITooQuiet',
    'SVEViseme', 'SDA_Consume_Leading_Spaces', 'SPWORD',
    'DISPID_SPIGrammarId', 'DISPID_SPPsItem',
    'DISPID_SRGCmdLoadFromMemory', 'DISPID_SGRSTWeight', 'SPSLMA',
    'SAFT48kHz8BitStereo', 'ISpeechResourceLoader',
    'DISPID_SGRSTsItem', 'DISPID_SpeechPhraseRules',
    'SGDSActiveUserDelimited', 'DISPID_SREmulateRecognition',
    'SECLowConfidence', 'SGPronounciation', 'eLEXTYPE_PRIVATE17',
    'DISPID_SGRId'
]

_check_version('1.2.0', 1629812704.729801)
